...
const colorPickerButton = "transition-all duration-200 h-8 w-8 flex items-center justify-center rounded-lg text-on-surface-variant hover:bg-black/5";

const colorSwatch = "w-4 h-4 rounded border border-gray-300";

const headingDropdown = "flex items-center gap-1 px-3 rounded-full hover:bg-black/5 flex-shrink-0";
...
const saveButton = "md:rounded-full rounded-lg bg-primary hover:bg-primary-dim border-none h-9 md:px-6 px-4 flex items-center gap-2 shadow-lg shadow-primary/20";
